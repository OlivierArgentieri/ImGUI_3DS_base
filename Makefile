...
3dslink:
	@$(MAKE) -f Makefile.3ds 3dslink -lssh

3dslink-classic:
	@$(MAKE) -f Makefile.3ds 3dslink CLASSIC="-DCLASSIC" -lssh
...
3dsx:
	@$(MAKE) -f Makefile.3ds 3dsx -lssh

3dsx-classic:
	@$(MAKE) -f Makefile.3ds 3dsx CLASSIC="-DCLASSIC" -lssh
...
release-3dsx:
	@$(MAKE) -f Makefile.3ds 3dsx DEFINES=-DNDEBUG OPTIMIZE="-O3 -flto -lssh"

release-3dsx-classic:
	@$(MAKE) -f Makefile.3ds 3dsx DEFINES=-DNDEBUG OPTIMIZE="-O3 -flto" CLASSIC="-DCLASSIC" -lssh
